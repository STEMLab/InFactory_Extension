...
public class IndoorFeaturesDAO {
	...
	public static IndoorFeatures createIndoorFeatures(IndoorGMLMap map, String id, String name, String description,	String multiLayeredGraph, String primalSpaceFeatures ) {
