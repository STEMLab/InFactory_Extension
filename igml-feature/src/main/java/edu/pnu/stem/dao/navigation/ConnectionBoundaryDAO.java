package edu.pnu.stem.dao.navigation;
...
public class ConnectionBoundaryDAO {
	...
	public static ConnectionBoundary createConnectionBoundary(IndoorGMLMap map, String parentId, String id, String name, String description, Geometry geometry, String duality) {
	...
	public static ConnectionBoundary updateConnectionBoundary(IndoorGMLMap map, String parentId, String id, String name, String description, Geometry geometry, String duality) {
