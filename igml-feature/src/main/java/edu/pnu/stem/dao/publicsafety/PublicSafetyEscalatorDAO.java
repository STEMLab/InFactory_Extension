...
public class PublicSafetyEscalatorDAO {
	...
	public static PublicSafetyEscalator createPublicSafetyEscalator(IndoorGMLMap map, String parentId, String id, String name, String description,	Geometry geometry, String duality, List<String> connects) {
		if (id == null) {
