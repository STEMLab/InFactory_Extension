...
public class PublicSafetyGeneratorDAO {
	...
	public static PublicSafetyGenerator createPublicSafetyGenerator(IndoorGMLMap map, String parentId, String id, String name, String description,	Geometry geometry, String duality, List<String> connects, String PSLegend) {
		if (id == null) {
