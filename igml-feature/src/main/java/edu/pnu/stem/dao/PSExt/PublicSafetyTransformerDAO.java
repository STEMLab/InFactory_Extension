...
public class PublicSafetyTransformerDAO {
	...
	public static PublicSafetyTransformer createPublicSafetyTransformer(IndoorGMLMap map, String parentId, String id, String name, String description,	Geometry geometry, String duality, List<String> connects , String PSLegend) {
		if (id == null) {
