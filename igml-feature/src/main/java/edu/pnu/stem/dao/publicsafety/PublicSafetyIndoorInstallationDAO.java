...
import edu.pnu.stem.feature.publicsafety.PublicSafetyIndoorInstallation;

public class PublicSafetyIndoorInstallationDAO {

	public static PublicSafetyIndoorInstallation readPublicSafetyIndoorInstallation(IndoorGMLMap map, String id) {
		PublicSafetyIndoorInstallation target = null;
		try {
			target = (PublicSafetyIndoorInstallation) map.getFeature(id);
	...
	public static PublicSafetyIndoorInstallation createPublicSafetyIndoorInstallation(IndoorGMLMap map, String parentId, String id, String name, String description,
			Geometry geometry, String duality, List<String> connects) {
		if (id == null) {
			id = UUID.randomUUID().toString();
		}

		PublicSafetyIndoorInstallation newFeature = new PublicSafetyIndoorInstallation(map, id);
		if (map.hasFutureID(id)) {
			newFeature = (PublicSafetyIndoorInstallation) map.getFutureFeature(id);
			// map.removeFutureID(id);
		} else {
			map.setFutureFeature(id, newFeature);
		}
		map.setFeature(id, "PublicSafetyIndoorInstallation", newFeature);
	...
	public static PublicSafetyIndoorInstallation createPublicSafetyIndoorInstallation(IndoorGMLMap map, String parentId, String id, String geometry,
	...
	public static void deletePublicSafetyIndoorInstallation(IndoorGMLMap map, String id) {
		PublicSafetyIndoorInstallation target = (PublicSafetyIndoorInstallation) map.getFeature(id);

		if (target == null) {
			if (map.hasFutureID(id))
				target = (PublicSafetyIndoorInstallation) map.getFutureFeature(id);
		}
	...
	public static PublicSafetyIndoorInstallation updatePublicSafetyIndoorInstallation(IndoorGMLMap map, String parentId, String id, String name, String description,
			Geometry geometry, String duality, List<String> connects) {
		
		PublicSafetyIndoorInstallation result = new PublicSafetyIndoorInstallation(map, id);
		PublicSafetyIndoorInstallation target = (PublicSafetyIndoorInstallation) map.getFeature(id);
		...
		map.removeFeature(id);
		map.setFeature(id, "PublicSafetyIndoorInstallation", result);
