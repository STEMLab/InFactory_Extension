...
public class PublicSafetyDoor extends ConnectionBoundary {
	...
	private String doorHandling;
	private String doorSwing;	
	...
	public void setDoorHandling(String doorhandling) {
		this. doorHandling = doorhandling;
		
	}
	public String getDoorHandling() {
		return this.doorHandling;
	}
	
	public void setDoorSwing(String doorSwing) {
		this. doorSwing = doorSwing;
		
	}
	public String getDoorSwing() {
