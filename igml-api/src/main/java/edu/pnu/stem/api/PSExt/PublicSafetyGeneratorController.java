...
import edu.pnu.stem.dao.PSExt.PublicSafetyGeneratorDAO;
...
public class PublicSafetyGeneratorController {
	...
	public void createPublicSafetyGenerator(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyGeneratorDAO.createPublicSafetyGenerator(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
