...
import edu.pnu.stem.dao.PSExt.PublicSafetyManualDAO;
...
public class PublicSafetyManualController {
	...
	public void createPublicSafetyManual(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyManualDAO.createPublicSafetyManual(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
