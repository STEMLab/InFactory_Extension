...
import edu.pnu.stem.dao.PSExt.PublicSafetyFirePumpDAO;
...
public class PublicSafetyFirePumpController {
	...
	public void createPublicSafetyFirePump(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyFirePumpDAO.createPublicSafetyFirePump(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
