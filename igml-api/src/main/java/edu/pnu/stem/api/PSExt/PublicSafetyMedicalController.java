...
import edu.pnu.stem.dao.PSExt.PublicSafetyMedicalDAO;
...
public class PublicSafetyMedicalController {
	...
	public void createPublicSafetyMedical(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyMedicalDAO.createPublicSafetyMedical(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
