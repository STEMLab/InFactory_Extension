package edu.pnu.stem.api.navigation;
...
import edu.pnu.stem.dao.navigation.AnchorBoundaryDAO;
...
public class AnchorBoundaryContoller {
	...
	public void updateAnchorBoundary(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			AnchorBoundaryDAO.updateAnchorBoundary(map, parentId, id, name, description, geom, duality);
		} catch (NullPointerException e) {
			e.printStackTrace();
			throw new UndefinedDocumentException();
		}
	...
	public void deleteAnchorBoundary(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			Container container = applicationContext.getBean(Container.class);
			IndoorGMLMap map = container.getDocument(docId);
			AnchorBoundaryDAO.deleteAnchorBoundary(map, id);
		} catch (NullPointerException e) {
			e.printStackTrace();
			throw new UndefinedDocumentException();
		}
