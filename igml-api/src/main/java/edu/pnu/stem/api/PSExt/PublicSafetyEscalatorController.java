...
import edu.pnu.stem.dao.PSExt.PublicSafetyEscalatorDAO;
...
public class PublicSafetyEscalatorController {
	...
	public void createPublicSafetyEscalator(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyEscalatorDAO.createPublicSafetyEscalator(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
