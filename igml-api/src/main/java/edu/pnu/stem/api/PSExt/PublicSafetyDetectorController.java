...
import edu.pnu.stem.dao.PSExt.PublicSafetyDetectorDAO;
...
public class PublicSafetyDetectorController {
	...
	public void createPublicSafetyDetector(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyDetectorDAO.createPublicSafetyDetector(map, parentId, id, name, description, geometry, duality, connected,PSLegend);
