...
import edu.pnu.stem.dao.PSExt.PublicSafetyKeyBoxDAO;
...
public class PublicSafetyKeyBoxController {
	...
	public void createPublicSafetyKeyBox(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyKeyBoxDAO.createPublicSafetyKeyBox(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
