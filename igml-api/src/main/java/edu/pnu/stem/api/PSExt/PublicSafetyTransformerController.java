...
import edu.pnu.stem.dao.PSExt.PublicSafetyTransformerDAO;
...
public class PublicSafetyTransformerController {
	...
	public void createPublicSafetyTransformer(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyTransformerDAO.createPublicSafetyTransformer(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
