...
import edu.pnu.stem.dao.PSExt.PublicSafetySprinklerDAO;
...
public class PublicSafetySprinklerController {
	...
	public void createPublicSafetySprinkler(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetySprinklerDAO.createPublicSafetySprinkler(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
