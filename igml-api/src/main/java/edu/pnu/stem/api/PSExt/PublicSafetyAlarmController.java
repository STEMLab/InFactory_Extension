...
import edu.pnu.stem.dao.PSExt.PublicSafetyAlarmDAO;
...
public class PublicSafetyAlarmController {
	...
	public void createPublicSafetyAlarm(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyAlarmDAO.createPublicSafetyAlarm(map, parentId, id, name, description, geometry, duality, connected, PSLegend );
