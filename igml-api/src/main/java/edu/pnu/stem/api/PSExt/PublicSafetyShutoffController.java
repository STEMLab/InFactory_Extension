...
import edu.pnu.stem.dao.PSExt.PublicSafetyShutoffDAO;
...
public class PublicSafetyShutoffController {
	...
	public void createPublicSafetyShutoff(@PathVariable("docId") String docId, @PathVariable("id") String id,
		...
		try {
			...
			s = PublicSafetyShutoffDAO.createPublicSafetyShutoff(map, parentId, id, name, description, geometry, duality, connected, PSLegend);
